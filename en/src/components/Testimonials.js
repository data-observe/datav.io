...
export let testimonials = [
  ...
  [
    {
      content: <>
    <p>We build xObserve not only for common users but also for developers.</p>
    <p className='mt-[4px]'>Developers should feel very easy and intuitive to redevelop on xObserve's codebase and we love how it can help developers solving their problems faster and better.</p>
      </>,
      url: 'http://im.dev',
      author: {
        name: 'Sunface',
        role: 'xObserve Creator',
