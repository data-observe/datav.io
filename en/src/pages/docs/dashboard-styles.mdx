...
2. Click `Background` field, don't select any item, just paste this string `https://github.com/xobserveio/assets/blob/main/dashboard/demo-background.jpg?raw=true` to input box
3. Press `Enter` key
