...
> You can find country codes, city names at [here](https://github.com/xobserveio/xobserve/tree/main/ui/public/plugins/panel/geomap)
...
<TextList>
    <li>Country code `US`,  defined in <Link href="https://github.com/xobserveio/xobserve/blob/main/ui/public/plugins/panel/geomap/countries.json">countries.json</Link> </li>
    <li>City names `Shanghai`, defined in <Link href="https://github.com/xobserveio/xobserve/blob/main/ui/public/plugins/panel/geomap/cities.json">cities.json</Link></li>
