...
> You can find country codes, city names at [here](https://github.com/observexio/observex/tree/main/ui/public/plugins/panel/geomap)
...
<TextList>
    <li>Country code `US`,  defined in <Link href="https://github.com/observexio/observex/blob/main/ui/public/plugins/panel/geomap/countries.json">countries.json</Link> </li>
    <li>City names `Shanghai`, defined in <Link href="https://github.com/observexio/observex/blob/main/ui/public/plugins/panel/geomap/cities.json">cities.json</Link></li>
    <li>Coordinates, passed by field with <Code>"type":"geo"</Code></li>
</TextList>

ObserveX lookup the coordinates of points first by country code, then by city name, and finally by coordinates.
