...
Time system in ObserveX is very simple: when you picked a time range, that time range will be used in all dashboards.
...
This is easy to do in ObserveX, just select a refresh interval next to `Refresh` icon in the top right corner.
