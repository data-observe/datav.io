...
Manage annotation through chart is not convenient, so ObserveX provides a panel annotation manager to manage all annotations.
...
because they are automatically created by ObserveX, not by user.
