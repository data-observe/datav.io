---
title: xObserve vs Grafana
description: 在 xObserve 之前已经有了不少数据可视化平台，一起来看看相比竞品，xObserve 的优势有哪些。
---

import TextList  from '@/components/docs/TextList'
import Code  from '@/components/docs/Code'

不得不说 Grafana 是一款开创性的伟大开源产品，它是全世界最流行的数据可视化平台。xObserve 与 Grafana 相比，未必更全面更优秀，但是我们也有自己的**巨大优势**。
