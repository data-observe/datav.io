...
> 具体的国家编码、城市名，可以在[这里](https://github.com/xobserveio/xobserve/tree/main/ui/public/plugins/panel/geomap)查阅
...
<TextList>
    <li> 国家编码 `US`，坐标索引定义在 <Link href="https://github.com/xobserveio/xobserve/blob/main/ui/public/plugins/panel/geomap/countries.json">countries.json</Link> </li>
    <li> 城市名称 `Shanghai`, 坐标索引定义在 <Link href="https://github.com/xobserveio/xobserve/blob/main/ui/public/plugins/panel/geomap/cities.json">cities.json</Link></li>
